...
namespace Division42.Data.Repository
{
    ...
    public abstract class SqliteRepositoryBase<TEntity, TKey> : IDisposable, IRepository<TEntity, TKey>
        where TEntity : class, new()
    {
        ...
        public IEnumerable<TEntity> GetAll()
        {
            ...
            {
                throw new DataException<TEntity,TKey>("Exception \"" + exception.GetType().ToString()
    ...
    /// </summary>
    /// <typeparam name="TEntity">The data structure type on which this repository operates.</typeparam>
    public abstract class SqliteRepositoryBase<TEntity> : SqliteRepositoryBase<TEntity, Guid>
        where TEntity : class, new()
    {
        /// <summary>
        /// Creates a new instance of this type.
        ...
        /// <param name="sqliteConnectionString">The SQLite connection string to be used by the SQLite PCL library.</param>
        /// <exception cref="ArgumentNullException"></exception>
        protected SqliteRepositoryBase(ISQLitePlatform sqlitePlatform, SQLiteConnectionString sqliteConnectionString) : base(sqlitePlatform, sqliteConnectionString)
        {
        }
    }
}
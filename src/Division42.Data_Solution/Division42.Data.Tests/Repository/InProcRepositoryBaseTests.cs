...
namespace Division42.Data.Tests.Repository
{
    ...
    public class InProcRepositoryBaseTests
    {
        ...
        [TestMethod]
        public void InferredKeyTypeConstructorWithNoArguments_ReturnsValidInstance()
        {
            CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository();
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void InferredKeyTypeConstructorWithNullList_ReturnsValidInstance()
        {
            CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository(null);
        ...
        [TestMethod]
        [ExpectedException(typeof(ObjectDisposedException))]
        public void InferredKeyTypeGetAllAfterDispose_ShouldThrowException()
        {
            CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository();
        ...
        [TestMethod]
        public void InferredKeyTypeGetAll_ReturnsExpected()
        {
            Int32 expected = 2;
            Int32 actual = -1;
            ...
            using (CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository(list))
            {
                IEnumerable<Customer> customers = repository.GetAll().ToList();
                actual = customers.Count();
        ...
        [TestMethod]
        public void InferredKeyTypeGetByIdWithValidId_ReturnsExpected()
        {
            Customer expected = new Customer() { CustomerId = Guid.NewGuid() };
            Customer actual;
            List<Customer> list = new List<Customer> { expected };
        ...
        [TestMethod]
        public void InferredKeyTypeGetByFilterWithValidArgument_ReturnsExpected()
        {
            Customer expected = new Customer() { CustomerId = Guid.NewGuid() };
            Customer actual;
            List<Customer> list = new List<Customer> { expected };
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void InferredKeyTypeGetByFilterWithNullArgument_ShouldThrowException()
        {
            using (CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository())
            {
                repository.GetByFilter(null);
        ...
        [TestMethod]
        public void InferredKeyTypeInsertWithValidItem_ShouldBeRetrievable()
        {
            Customer expected = new Customer() { CustomerId = Guid.NewGuid() };
            Customer actual;
        ...
        [TestMethod]
        public void InferredKeyTypeUpdateWithValidItem_ShouldUpdate()
        {
            String expected = "Unittest";
            String actual;
        ...
        [TestMethod]
        public void InferredKeyTypeDeleteWithValidItem_ShouldDelete()
        {
            Customer actual;
            Customer customer = new Customer() { CustomerId = Guid.NewGuid() };
            List<Customer> list = new List<Customer> { customer };
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void InferredKeyTypeInsertWithNullArgument_ShouldThrowException()
        {
            using (CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository())
            {
                repository.Insert(null);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void InferredKeyTypeUpdateWithNullArgument_ShouldThrowException()
        {
            using (CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository())
            {
                repository.Update(null);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void InferredKeyTypeDeleteWithNullArgument_ShouldThrowException()
        {
            using (CustomerWithInferredKeyInProcRepository repository = new CustomerWithInferredKeyInProcRepository())
            {
                repository.Delete(null);
